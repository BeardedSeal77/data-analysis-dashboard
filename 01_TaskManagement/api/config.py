...
def load_secrets():
    ...
    # Look for secrets.txt in the root directory (two levels up from this file)
    secrets_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'secrets.txt')
