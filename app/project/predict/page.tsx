          ...
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-lg font-semibold text-red-900 mb-2">
                Important: Prediction Results Disclaimer
              </h3>
              <p className="text-red-800 text-sm mb-3">
                <strong>The prediction results generated by this model are not reliable for actual analysis.</strong>
              </p>
              <p className="text-red-800 text-sm">
                The datasets used in this project consist of metadata aggregated at the national level, which are fundamentally incompatible with machine learning predictions.
                The training and validation datasets do not represent individual-level observations but rather summary statistics, making the model predictions meaningless in a real-world context.
                This implementation is provided solely as a <strong>proof of concept</strong> to demonstrate the technical capabilities of the ML pipeline and web interface.
                The underlying data issues were inherited from the provided course materials.
              </p>
            </div>
          </div>
        </div>
